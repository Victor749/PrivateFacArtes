...
function guardarEdicion(idComentario){
   // console.log(globalBoton);
    ...
    if(nuevoC == ''){
        ...
        var url = "https://facultadartescuenca.com/museovirtual/comentarios/editComentario";
...
function eliminar(idComentario){
  ...
  //  console.log(idComentario);
    var url = "https://facultadartescuenca.com/museovirtual/comentarios/deleteComentario/"+idComentario;
    var xhr = new XMLHttpRequest();
